...
struct ThemeView_Previews: PreviewProvider {
    ...
    static var theme = Binding.constant(Theme(name: "Theme", goals: [Goal(name: "Goals", tasks: [Task(description: "Task1")]), Goal(name: "Goal2", tasks: [Task(description: "Task1")])]))
    
    static var previews: some View {
        ThemeView(theme: Theme(name: "Work", goals: [Goal(name: "Work1")]))
    }
}
